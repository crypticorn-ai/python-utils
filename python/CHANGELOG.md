...
- Change page type from Optional[int] to int in PaginationParams
  ([`b34969a`](https://github.com/crypticorn-ai/util-libraries/commit/b34969adaaa13433080c762540365cd9a76da060))

### Chores

- Update changelog file location and remove unused script entry
  ([`ee7ac5d`](https://github.com/crypticorn-ai/util-libraries/commit/ee7ac5d5da2b65b5b1067f970cc3376cc74769d6))
